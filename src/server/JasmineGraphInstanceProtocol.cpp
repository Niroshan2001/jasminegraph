...
const string JasmineGraphInstanceProtocol::ROUTER_SERVER_START            = "router-server-start";
const string JasmineGraphInstanceProtocol::ROUTER_SERVER_START_ACK        = "router-server-start-ack";
